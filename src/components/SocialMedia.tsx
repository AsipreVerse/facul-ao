...
export const socialMediaProfiles = [
  { title: 'Instagram', href: 'https://www.instagram.com/facul.ao', icon: InstagramIcon },
  { title: 'Facebook', href: 'https://www.facebook.com/facul.ao', icon: FacebookIcon },
  { title: 'LinkedIn', href: 'https://ao.linkedin.com/company/grupo-facul', icon: LinkedInIcon },
]
