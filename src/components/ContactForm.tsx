    ...
    return (
        <FadeIn className="lg:order-last">
            <form ref={formRef} onChange={checkFormValidity} onSubmit={(e) => e.preventDefault()}>
                ...
                {/* Data Protection Consent - Lei n.º 22/11 (Angola) */}
                <div className="mt-6 rounded-lg border border-neutral-200 bg-neutral-50 p-4">
                    <label className="flex items-start gap-3 cursor-pointer">
                        <input
                            ...
                            name="consent"
                            required
                            className="mt-1 h-5 w-5 flex-none appearance-none rounded border border-neutral-300 bg-white checked:border-neutral-950 checked:bg-neutral-950 focus:ring-2 focus:ring-neutral-950/20"
                            onChange={checkFormValidity}
                        />
                        <span className="text-sm text-neutral-600">
                            Consinto o tratamento dos meus dados pessoais pelo Grupo Facul,
                            exclusivamente para responder ao meu pedido de contacto, nos termos
                            da <a href="/privacidade" className="text-neutral-950 underline hover:no-underline">Política de Privacidade</a> e
                            em conformidade com a Lei n.º 22/11 de Protecção de Dados Pessoais de Angola.
                            Os dados não serão partilhados com terceiros e posso solicitar a sua
                            eliminação a qualquer momento através de <strong>geral@facul.ao</strong>.
                        </span>
                    </label>
                </div>
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-4">
                    <button
                        ...
                        disabled={!formValid}
                        className="inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-6 py-3 text-base font-semibold text-white transition hover:bg-[#1da851] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                        ...
                        onClick={handleEmail}
                        disabled={!formValid}
                        className="inline-flex items-center justify-center gap-2 rounded-full bg-neutral-950 px-6 py-3 text-base font-semibold text-white transition hover:bg-neutral-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
