...
export default async function Privacy() {
    ...
    const legalPage = await getLegalPage('privacidade')
    const hasCmsContent = legalPage?.contentEn && Array.isArray(legalPage.contentEn) && legalPage.contentEn.length > 0
            ...
            <Container className="mt-24 sm:mt-32 lg:mt-40">
                <FadeIn>
                    <div className="prose prose-neutral max-w-3xl">
                        {hasCmsContent ? (
                            <PortableText content={legalPage.contentEn} />
                        ) : (
                            <>
